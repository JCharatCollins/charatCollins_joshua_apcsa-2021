...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorDiagonal()
  {
    ...
    {
      for (int col = 0; col < Math.min(pixels.length, width); col++)
      {
        botRight = pixels[row][col];
        topLeft = pixels[col][row];
        botRight.setColor(topLeft.getColor());
      }
    } 
  }
  ...
  public void copy(Picture fromPic, int startRow, int startCol, int fromStartRow, int fromStartCol, int fromEndRow, int fromEndCol){
	  Pixel fromPixel = null;
	  Pixel toPixel = null;
	  Pixel[][] toPixels = this.getPixels2D();
	  Pixel[][] fromPixels = fromPic.getPixels2D();
  ...
  public void createCollage()
  {
    ...
    Picture flower2 = new Picture("C://Users/jchar/Downloads/images/flower2.jpg");
    ...
    this.mirrorVertical();
    this.write("C://Users/jchar/Downloads/images/collage.jpg");
  }
  public void createCollage2()
  {
    ...
    this.copy(flower2,0,100,25,25,75,75);
    this.copy(flower1,0,200,50,50,100,100);
  ...
  public void edgeDetection2(int edgeDist)
  {
    ...
    for (int row = 0; row < pixels.length-1; row++)
    {
           ...
           col < pixels[0].length-1; col++)
      {
        ...
        botRightColor = botRight.getColor();
        if (topLeft.colorDistance(botRightColor) > 
            edgeDist)
    ...
    for (int row = 1; row < pixels.length; row++)
    {
           ...
           col < pixels[0].length; col++)
      {
    	...
    	botRight = pixels[row][col];
    	botRightColor = topLeft.getColor();
        if (botRight.colorDistance(botRightColor) > 
            edgeDist)
